...
<sql:query var="searchBooks" dataSource="jdbc/libmanage">
    ...
    FROM book inner join book_copy on book.ISBN=book_copy.ISBN where book_copy.is_issued = 0 and is_damaged = 0 and title = ?<sql:param value="${param.title}"/> group by book.isbn
